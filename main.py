"""Модуль реализует выбор типа персонажа и тренеровк."""
...
def attack(char_name: str, char_class: str) -> str:
    """Функция реализует действие атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция реализует действие защиты."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция реализует действие специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция реализует выбор действия персонажа во время тренировки."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция реализует выбор типа персонажа."""
    approve_choice = None
    char_class = None
